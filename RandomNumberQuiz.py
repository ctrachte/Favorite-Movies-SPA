...
placehold=0
print "Below is an array of random numbers, and a table of their occurences:"
print random_list
print "Number | Occurrence"
while placehold < len(count_list):
    if placehold == 10:
        print "     " + str(placehold) + "| " + str(translate_count[count_list[placehold]])
    else:
        print "     " + str(placehold) + " | " + str(translate_count[count_list[placehold]])
    placehold+=1
